                        ...
                        <div class="banner-overlay p-4 d-flex flex-column justify-content-end">
                            <div class="container-fluid px-0">
                                ...
                                <p class="text-white opacity-75 mb-0">
                                    <i class="bi bi-person-circle me-1"></i> Organized by: <strong><?= e($event->creator_name ?: 'Administrator') ?></strong>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-12 col-sm-6 col-lg-3">
            <div class="card h-100 border-0 shadow-sm bg-white rounded-4">
                <div class="card-body d-flex align-items-center p-4">
                    ...
                    <div>
                        <h6 class="text-muted font-semibold mb-1 small text-uppercase">Capacity</h6>
